            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-primary/80 mb-2">
          ...
          <div className="my-auto flex flex-col space-4">
            ...
            <div className="flex flex-col my-4">
              <p className="mb-4 text-center  text-lg">
                Our services are tailored to individual clients needs. The
                primary goal in our operatios is setting products on the path to
                success
              </p>
              <Link
