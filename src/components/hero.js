...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="sm:h-screen bg-cover bg-[url('/images/colleagues-hero.jpg')] overflow-hidden"
    >
      <div className="relative w-full h-full flex flex-col bg-purple-950/80 items-center justify-center">
        ...
        <Link
          href="#brief-aboutUs"
          className={`transition-all ${top ? "animate-bounce" : "hidden"}`}
        >
          <svg
            viewBox="0 0 24 24"
