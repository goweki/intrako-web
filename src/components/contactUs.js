            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="py-8 md:py-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-4xl mx-auto">
                        ...
                        <div>
                            <form onSubmit={handleSubmit} name="contact" data-aos="fade-left" className="py-3 md:py-6">
                                <div>
                                    <label className="block text-base tracking-tight text-gray-400">
                                        Name *
                                    </label>
                                    <input
                                        name="name"
                                        ...
                                        required
                                        className="mt-2 w-full border-none text-sm p-4 bg-gray-700 text-gray-200 placeholder:italic"
                                    />
                                </div>
                                <div className="mt-6">
                                    <label className="block text-base tracking-tight text-gray-400">
